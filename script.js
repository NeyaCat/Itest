...
function descriptions() {
    ...
    switch (type) {
        /* 捕食者 DESCRIPTIONS */
        case 'IVAN':
            title2.innerText = '暴食者';
            textarea.innerHTML = typeDesc;
            textareaheader.innerText = "”现在，你彻底成为我的所有物了，小点心~“";
            textarea2.innerText =
                '作为一名顶级捕食者，填饱肚子是你唯一关心的事情。\n' +
                '而世界上绝大部分个体都可以用来填饱自己，因为在你的眼里，他们都是美味的食物。\n' +
                '你积极地狩猎他们，唯一的目的就是填满你那永远无法被填满的饥饿感。\n' +
                '他们也许会挣扎、抵抗，但这也不过是些辅助消化和提升食欲的有氧运动，因为作为食物链顶端的存在，你总能成为最终赢家。\n' +
                'IVAN型捕食者从不关心猎物的感受，只要足够美味，任何人都可能被她们送入胃中并给她们带来极致的享受。\n';
            break;
        case 'IVAX':
            title2.innerText = '魅魔';
            ...
            textarea2.innerText =
                ...
                "IVAX型的捕食者会沉浸在猎物的蠕动和反抗中，尤其是他们在正确方向上做出的恰到好处的挣扎和抵抗。\n";
            break;
        case 'IVPN':
            title2.innerText = '蜘蛛';
            textareaheader.innerText =
            ...
            textarea2.innerText =
                ...
                "正如俗语所言，成功最终属于耐心等待的人。\n" +
                "IVPN型的捕食者擅于玩弄自己的猎物，引诱他们逐渐沦陷，最终将身心全部奉献出去。";
            break;
        case 'IVPX':
            title2.innerText = '海妖';
            textareaheader.innerText =
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "区别于IVPN型捕食者的饥不择食，你会在吃掉猎物前认真考虑他们的长相。" +
                ...
                "IVPX型捕食者一直清楚一件事情，那就是猎物被彻底消化之后，他们的某些特质将会成为自己美妙躯体的一部分。";
            break;
        case 'IEAN':
            ...
            textarea2.innerText =
                ...
                "与其将你形容成一名优秀的捕食者，不如说猎食的行为只是你为了达成目的的一种手段。" +
                "你不仅通过消化他们的身体来满足你的饥饿感，还能通过欣赏他们绝望的抵抗也能令你获得在情感和精神上的额外满足。" +
                "IEAN型捕食者从不认为吃掉猎物这件事是理所应当的，但她们会为了达到某种目的而选择将对方当做食物吃掉。\n";
            break;
        case 'IEAX':
            ...
            textarea2.innerText =
                ...
                'IEAX型捕食者并非总是恶意的，也许她们只是单纯的喜欢和猎物调情，或者在吃掉猎物的时候玩弄他们。 \n';
            break;
        case 'IEPN':
            ...
            textarea2.innerText =
                ...
                "IEPN型捕食者吃掉猎物的动机是复杂且被动的，但有一点毋庸置疑，她们享受与猎物之间的保持微妙关系的状态，同时享受猎物主动投喂自己带来的精神与食欲的双重满足。 \n";
            break;
        case 'IEPX':
            ...
            textarea2.innerText =
                ...
                'IEPX型捕食者喜欢与自己的猎物玩一场精心策划的情感游戏，她们诱人的本性使得大部分人难以抗拒，即使她们趋于被动地等待猎物找上自己。';
            break;
        case 'SVAN':
            ...
            textarea2.innerText =
                ...
                'SVAN型捕食者相比起自己的体验和欲望，往往会优先考虑猎物的体验和欲望，而这也就意味着任何成为她们食物的个体都能得到她们最友善的照顾，并在愉快中溶解在她们的肚子里。';
            break;
        case 'SVAX':
            ...
            textarea2.innerText =
                ...
                'SVAX型捕食者中，有些会为了达成目的而使用一些欺骗手段，但她们中的大多数还是希望猎物的经历和她们描述的内容一致，以此让猎物对最终的结果感到满意。';
            break;
        case 'SVPN':
            ...
            textarea2.innerText =
                ...
                'SVPN型捕食者难以在自己的欲望和照顾周围人感受的纠结中做出选择，通常她们都会屈服于自己的欲望，但也保不准在极个别时候友谊的力量真的能更胜一筹？';
            break;
        case 'SVPX':
            ...
            textarea2.innerText =
                ...
                'SVPX型捕食者往往能够很自然地用吞食行为取代性行为，并让自己的伴侣很好地融入其中，至于接下来他到底以什么样的形态从哪里出来，这就不得而知了……';
            break;
        case 'SEAN':
            ...
            textarea2.innerText =
                ...
                'SEAN型捕食者更关心与猎物的互动和情感联系，而不仅仅是食物摄取，猎物的概念也不仅仅只是食物，而是情感关系的另一半。';
            break;
        case 'SEAX':
            ...
            textarea2.innerText =
                ...
                "SEAX型捕食者会注重猎物的态度和感受，注重分享情感和体验欲望，她们的猎物通常都是在兴奋中融入她们的身体，并以此来满足她们支配猎物的欲望。";
            break;
        case 'SEPN':
            ...
            textarea2.innerText =
                ...
                "SEPN型捕食者几乎不存在关于饥饿感的欲望诉求、不会为了满足口腹之欲而去进食，她们中的一些个体甚至不认为自己是所谓的捕食者。";
            break;
        case 'SEPX':
            ...
            textarea2.innerText =
                ...
                "SEPX型捕食者会与她们的猎物建立起牢固的情感连接，不希望他们受到任何伤害，当然，她们也不太愿意接受自己的猎物要求她们伤害他们本身。";
            break;
        ...
        case 'IVAN-W':
            ...
            textarea2.innerText =
                ...
                "你渴望被某人的喉咙紧紧束缚，你幻想被胃中消化的低吟缠绕，你期待某位捕食者将自己放入她的餐盘。" +
                "但是你知道，无论过程如何，你注定会成为某位女孩的食物。" +
                "你到处寻找捕食者，并试图主动被她们吃掉，以至于大部分人都知道你的存在，一个随时可以用于满足自己的小点心。" +
                "IVAN自愿型猎物更注重于被吃掉的过程体验，只要能被吃掉，捕食者的身份和类型并不是什么重要的事情。";
            break;
        case 'IVAX-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你积极追求你的吞食梦想，试图在每次遇到的捕食者身上把你的幻想变成现实。" +
                "有些捕食者或许会对你的主动感到质疑和警惕，但当你在她们的胃里晃动时，所有的疑虑都会消失。" +
        ...
        case 'IVPN-W':
            ...
            textarea2.innerText =
                "关于等待这件事，你比大多数人都要熟练。" +
                "你经常听到其他人谈论关于他们遇到的各种捕食者的经历，但是你仍然无法鼓起勇气主动寻找。" +
                "因为你被动的本质阻止了你进一步接近捕食者，即使你十分渴望被她们的胃壁包裹。" +
                "因此你会一直等待下去，因为你相信迟早有一天会有一名捕食者悄悄盯上你，然后在她饥渴的欲望中将你吞食。" +
        ...
        case 'IVPX-W':
            ...
            textarea2.innerText =
                ...
                "不过，如果有一个捕食者将你逼入绝境，或者她提出了令你无法拒绝的酬劳的话……" +
                "IVPX-自愿型猎物绝不会真的将自己的想法付之于行动，即使真的被逼入绝境，也只会在口嫌体正直中滑入捕食者的肚子，但不可否认，这确实是他想要的东西……";
            break;
        case 'IEAN-W':
            ...
            textarea2.innerText =
                ...
                "如果一定要选择一个地方让你度过余生，那一定是某个捕食者的肚子里，只要能够待在里面，光是想想都难以掩盖那份期待与冲动。" +
                "因此你会主动去寻找捕食者，在她们的体内找到那一份属于自己的安宁。" +
        ...
        case 'IEAX-W':
            ...
            textarea2.innerText =
                ...
                '所以，你会四处探险，会寻找新的喉咙与肚子进行探索，而不是被束缚在某一个捕食者的体内。至少，你主观上是这样期待的。' +
                'IEAX自愿型猎物过于主动，但也过于自我，他们不太会关注某些捕食者是否希望他们留下，就如同清纯的少女想要挽留住她花心的男友。这样的猎物，还是交给暴食们进行无害化处理吧。 \n';
            break;
        case 'IEPN-W':
            title2.innerText = '内向者';
            textareaheader.innerText =
                "一个把我当成食物并像对待食物一样对待我的捕食者！嗯……我想我需要先冷静一下……";
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                ...
                "你通常并不关心捕食者的身份，但和幻想者类似的，你幻想者总有一天，会有某个捕食者以某种方式接近你，而你恰好在某些方面的特质让她产生了食欲，随后她一口吞掉了你。" +
        ...
        case 'IEPX-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你很容易慌乱，哪怕仅仅只是看了一眼捕食者都可能导致你面红耳赤，心跳不已。' +
                '你的被动特性通常让你在捕食者面前显得无比乖巧与顺从，那些善于戏弄自己猎物或者善于调情的捕食者能够更好地激发你的性欲，而你将任凭她们摆布。' +
                '在对捕食者的挑选方面你有着特殊的见解，你更喜欢那些你认为性感和迷人的捕食者，尤其是那些能够挑动你的内心，抓住你的爽点的捕食者。' +
                'IEPX自愿型猎物更容易受到捕食者的影响，或者说，捕食者的存在本身就会不断刺激他们的情绪感官，哪怕只是想想都觉得兴奋不已。';
            break;
        case 'SVAN-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你也许会将自己的定位视作食物，但你并不会像IVAN型猎物那样去寻找任意捕食者来满足自己作为食物的欲望。" +
                "比起成为随机陌生的捕食者的食物，你更倾向于为自己的朋友或者真正需要自己的捕食者保留自己的价值，虽然你们之间的关系仍然是一种交易。" +
                "即：你为了满足被吃掉的体验而奉献自己，她为了满足吃掉你的快乐而向你索取。" +
                "SVAN自愿型猎物能够很快结交到捕食者朋友，当他们产生了任何关于想要被吃掉的欲望时，他们可以拜托这些捕食者朋友。";
            break;
        case 'SVAX-W':
            ...
            textarea2.innerText =
                ...
                '你会难以遏制地主动吸引那些潜在的捕食者，比如穿着耀眼的服饰、打扮得秀色可餐、让自己闻起来令人食欲大动，或者采取一些别的方式。' +
                '当你深刻地了解到了某位潜在捕食者的捕食规律时，你也不会介意去主动触发这些东西，而你的目的只有一个，那就是激起她的食欲，让她难以遏制将你吃掉的欲望。' +
                '同时你也会积极地追求与捕食者进行难以启齿的涩涩运动，体验被她们吃掉的刺激，以及享受到那些吃掉你的捕食者的赞美。' +
                'SVAX自愿性猎物喜欢寻求性刺激，并且同时与捕食者维系着吃与被吃的紧密关系，这两件事对他们而言并非是某种选择题，而是相辅相成的极致体验。';
            break;
        case 'SVPN-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "虽然你并不积极寻求成为食物的机会，但你仍然可能会结识多位捕食者。" +
                "你的目的很明确，那就是期望着她们中的某一个最终会做出吃掉你的决定并赴之于行动，比起这个，你并不愿意冒险跟陌生的捕食者做出尝试。" +
                "如果你最终成为了朋友的食物，你会得到额外的满足，但你通常很难鼓起勇气表明你对被吃掉这件事的真实感受。" +
                "以至于你的捕食者朋友们通常都会对你做出错误的评估，认为你对被她们吃掉这件事压根就不感兴趣。" +
                "SVPN自愿型猎物是一种情感特质明显的猎物类型，比起被吃掉这件事本身，他们更加注重与捕食者之间的朋友关系和情感连接。";
            break;
        case 'SVPX-W':
            ...
            textarea2.innerText =
                ...
                '你会努力与你认为有吸引力的捕食者建立联系，希望能够被她们吞下并一段时间里成为她们性感的胃里的一个鼓包，甚至是融入她们的身体中。' +
                '与SVAX型猎物的主动奉献不同，你更愿意被捕食者主导并吞下，而你则完全顺从并享受这一过程；' +
                '同时，与SEPX自愿型猎物通过被支配制造亲密连接不同，你更专注于与捕食者最为激情的瞬间，并从中获得愉悦。' +
                '如果你找到了与你相互匹配的捕食者类型，这可能会形成一种潜在的不稳定的反馈循环……你们相互取悦，相互满足，迟早有一天你会彻底陷入其中，无法脱身。' +
                'SVPX自愿型猎物善于在被吃掉的过程中取悦捕食者，并且他们自己也能在这个过程中获得满足，他们可能会倾向于和那些寻找愉悦体验的捕食者建立联系。';
            break;
        case 'SEAN-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你在获得快乐的方式上通常会和你的捕食者有着相似的观点，即你们都期望食物能在捕食者的体内度过更多的时间。' +
                '你会积极促进双方更快地进入到吞食的阶段，在她们的肚子里给她们做一些腹内按摩，以此来保证自己能有更长的时间待在她们的体内。' +
                '你可能还会希望与捕食者融为一体，因为你认为你们双方都将从“猎物成为更强大个体的一部分”中受益。' +
                '无论如何，你具备着较强的适应性，能够与几乎类型的捕食者形成更深层次的联系，但你可能会觉得拥有自我特质和本能特质的捕食者有些过于偏激。' +
                'SEAN自愿型猎物渴望与捕食者拥有更加亲密的关系，享受被吞食带来的感觉，在捕食者的体内度过时间能给他们带来快感和满足。';
            break;
        case 'SEAX-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你非常了解自己的兴趣与欲望，喜欢寻找与你的特质相匹配的捕食者。" +
                "你擅长勾引，或利用性挑逗和嘲弄刺激捕食者，使她们充分陷入兴奋的状态，并在充满欲望的状态下吞食你。" +
                "如果捕食者不喜欢或者不回应你的刺激和怂恿，那么你则不会希望被她们吃掉，因为于你而言，只有双方都处于开心和期待的情况下，吞食的行为才会是有意义的。" +
                "你还可能寻求成为一个吸引人的捕食者的一部分，或者加入捕食者的身体曲线以帮助她们变得更具吸引力。因为你觉得成为捕食者的一部分或者以其他方式使她们变得更迷人会让你得到满足。" +
                "SEAX自愿型猎物寻求与捕食者进行情欲上的互动，但他们更注重感官上的体验，他们或许愿意被捕食者消化，但那绝不是为了满足她们的口腹之欲，而是以这种方式成为她们迷人身体的一部分。";
            break;
        case 'SEPN-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你是一个专注于满足捕食者的角色，你乐于在成为她们的食物这方面无私奉献并享受这个过程给你带来的快乐。" +
                "你通常会选择将控制权彻底交给你的捕食者，不管你需要在她们的体内待上多久，你都会满足地彻底在她们的体内彻底放松下来，不会做任何多余的事情。" +
                "如同其他拥有情感特质的猎物，你同样渴望与捕食者建立更加亲密的联系，因此你认可的捕食者多是你的朋友，而不是陌生人。" +
                "你偶尔会将自己视作朋友的私人小零食或者吮吸小玩具，每当她们有这样的需求时你都会顺从地被她们拿走和使用。" +
                "SEPN自愿型猎物的兴趣更多地来自于他们的情感特质，于他们而言，被吃掉的感觉要高于性兴奋。他们就像一个绝对服从的仆人，不会反抗，不会挣扎，他们将自己的一切都奉献给被他们认可的捕食者朋友。";
            break;
        case 'SEPX-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你是一个专注于满足捕食者的角色，你将自己的身份看作是“可食用的性玩具”，在需要的时候取悦你的爱人、主人或者朋友。' +
                '你愿意将自己彻底交给你的捕食者以此来满足自己的性欲，甚至包括在各种程度上被她们消化。' +
                '如同其他拥有情感特质的猎物，你同样渴望与捕食者建立更加亲密的联系，因此你认可的捕食者多是你的朋友，爱人或者主人，而不是陌生人。' +
                '同时，你的情感特质也令你渴望被捕食者调情和赞美，并与她们建立更加长久的联系。' +
                'SEPX自愿型猎物会在被控制和使用时感到性愉悦，他们渴望情感上的互动，他们的情感特质导致他们能够选择的捕食者数量较少，但关系却更为亲密。';
            break;
        ...
        case 'IVAN-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你有着丰富的从捕食者嘴里逃离的经验，因为你从不屈服于成为食物的命运。" +
                "尽管许多捕食者们知道你不是那么容易被吃下的猎物，但她们仍然不打算就此放弃吞下你的想法。" +
                "也许，她们中的一部分个体认为能够消化如此强大的猎物是一种值得争取的挑战和成就？" +
                "无论如何，那些想要成为某人食物的想法令你十分困惑，你永远不会允许自己成为猎物，你会千方百计地从任何想要吃掉你的人的身体里逃离。" +
                "IVAN非自愿型猎物的本质大概就是不喜欢吞食爱好的普通人吧？如果当他们被卷入某位捕食者的嘴里，他们的唯一想法就是逃离这里并活下去，哪怕这会对捕食者造成相当严重的伤害。";
            break;
        case 'IVAX-U':
            ...
            textarea2.innerText =
                ...
                "IVAX非自愿型猎物潜在地将吞食与性欲联系在一起，但这还不足以打败他们对活着的渴望。因此，他们虽然在被吞下之后感到兴奋，但又试图否认这种感觉，认为继续挣扎比因性欲而停下来更为重要。\n";
            break;
        case 'IVPN-U':
            ...
            textarea2.innerText =
                ...
                '你知道作为猎物，大概率是要被捕食者吃掉的，因此在这样的命运真的降临之时，你只会做出最基本的抵抗。' +
                '你的被动特质注定了你难以在胃壁中坚持太久，尽管也许这种表现会使某些期待食物挣扎的捕食者感到无聊，进而考虑放你一马……？那么,你认为活下来的结局确实是你真正期待的吗？' +
                'IVPN非自愿型猎物很容易放弃他们的抵抗，并在捕食者的腹中轻易接受他们的命运。但并不否认，这样的表现有时确实能造成一些意料之外的结局。';
            break;
        case 'IVPX-U':
            ...
            textarea2.innerText =
                ...
                "你绝对是一个复杂的猎物，因为你知道被吞食这件事到底有多么的危险，捕食者的体内到底有多么恶心，但如果你真的深陷其中，你就会很快屈服。" +
                "一旦捕食者开始吞食你，你就会感到兴奋，明白被她们细长滑腻的舌头品尝你的身体是一种令你难以抗拒的奇妙刺激。" +
                "大抵上你还是愿意接受被吃掉的命运的，因为真实的体验确实和你想的差距很大，但总的来说并不亏，美妙的体验大抵胜过最初的不情愿。" +
                "IVPX非自愿型猎物是复杂且矛盾的，他们在真的被吞下之前是发自真心的抵触，但在那之后也是发自真心的渴望，并且这种渴望更多地来自性与本能的欲望。";
            break;
        case 'IEAN-U':
            ...
            textarea2.innerText =
                ...
                "IEAN捕食者和IEAN-W都能在吞与被吞的过程中找到各自的目标和意义并实现自身价值，而你只会因为忧郁的情节开始后悔原来自己还有很多理想可以实现。" +
                "所以，你开始挣扎，开始反抗自己的命运，开始向往自由，幻想自己能够逃脱，并告诉自己世界那么大不该止步于此……所以你早干嘛去了？" +
                "不可否认，你的情感特质确实能成为你优秀的武器，许多含有情感特质，特别是分享型情感特质的捕食者确实会被你强烈的表达所打动，进而真的考虑放过你……但，这样的捕食者又有多少呢？" +
                "IEAN非自愿型猎物在被吞食的时候会如同许多身陷囹吾的漫画角色一样通过回忆杀、未完成之事获得力量，摆脱困境。但总的来说，除了SE型捕食者，这样的力量往往都起不到多大的决定性作用。";
            break;
        case 'IEAX-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你是一个容易慌乱、摇摆不定的猎物。虽然你的自我特质让你尽量避免被吃掉的处境，但当捕食者在你的面前张开她们的嘴时，你还是会忍不住多看一眼……也许这一眼，就是永恒。" +
                "你会在捕食者的面前以及里面坚决地挣扎，声称自己不是食物，你从不轻易放弃抵抗，而这所有的一切不过是为了掩盖你内心深处的兴奋和激动。" +
                "因为你知道这样通常都能勾起捕食者玩弄自己猎物的兴趣，进而将这种兴趣在你的身上付之行动……是的，你的抵抗，你的挣扎，你的反对，其实本质上就是在说，“快，快欺负我！我真的很享受！”" +
                "呵，真是个傲娇的小可爱，只要她开始嘲笑你的命运，告诉你你的味道有多棒，嘲笑你的反抗是多么无力，你的挣扎令她感觉愉悦，帮你描述接下来你会经历的场景，会加入的部位，你就会在她的肚子里蠕动一整个夜晚。" +
                "IEAX非自愿型猎物通关坚决的挣扎和抗议来掩盖自己的兴奋，捕食者只需要不停地嘲笑、挑逗、露出享受的样子，就可以激发起他们的欲望，引发他们的反应。";
            break;
        case 'IEPN-U':
            ...
            textarea2.innerText =
                ...
                "一旦捕食者发现了你的存在，你就会立刻放弃抵抗，彻底交出控制权，屈服于自己成为食物的命运，哪怕其实那个时候捕食者根本就还没来得及做什么。" +
                "你是被动的猎物，通常只会做出最为简单的逃跑尝试，并且，捕食者只需要对着她的肚子稍微一拍，就能让你立刻安静下来。" +
                "另外……如果当她将肚子里的你介绍给了你的朋友，当你的朋友得知了你现在只不过是她肚子里的食物……这样的结果大概会让你觉得尴尬又兴奋。" +
                "IEPN非自愿型猎物与IVPN非自愿型猎物不同，IVPN-U主要担心自己是否会被消化这个问题，而IEPN-U只在乎当别人发现自己成为了捕食者的食物以后会有什么反应。";
            break;
        case 'IEPX-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "许多捕食者将你误以为是IEPX-W猎物，即使你掩盖了自己内心最深处的欲望，否认自己渴望被吃掉的事实。" +
                "所以，哪怕即使你嘴上真的在否认，然而一旦你真的进入了捕食者的肚子里，被她们软滑的肉壁所束缚而产生的性刺激仍然会压过你最初的不满与抵触情绪。" +
                "因此，当这一切真实发生的最初的那段时间，你会像是IEPX-W猎物那样感觉舒适，感到兴奋，感受性刺激，并接受自己作为食物的这一身份。" +
                "然而一旦捕食者的身体开始消化你，或者被她们无限期地困在肚子里，你还是会后悔自己最初的想法和决定。毕竟你接受的只是肉壁和体内环境带给你的性刺激，而不是接受了成为食物的命运。" +
                "IEPX非自愿型猎物中的相当一部分个体可能真的对吞食并没有太多的渴望，但被肉壁包裹带来的性刺激会让他们暂时忽略自己的抗议和反对，在真的被捕食者消化之前享受这一切带来的快乐。";
            break;
        case 'SVAN-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "其他的猎物偶尔能看到你和一位捕食者同时出现，但你从未消失在他们活动的区域。要问为什么的话，或许曾经被你投喂给她的张三李四王五可以回答这个问题……" +
                "你通过和捕食者社交甚至是交易，说服她们，让她们承认这样一件事：比起将你作为一顿饭消耗掉，把你当做长期合作的伙伴得到的价值要高得多。" +
                "与其说你是某种猎物，不如说你更像是捕食者的饲养员，因为你总是为她们提供新的猎物，以保证你所饲养的捕食者不会将你当做她们的下一顿。" +
                "但你应该随时警惕她们肚子里的咕噜声，因为许多处于饥饿当中的捕食者不太愿意进行过长时间的等待，也许下一个滑进她们肚子里的食物就是你自己。" +
                "SVAN非自愿型猎物会试图和捕食者建立交易与合作，用牺牲其他猎物同类的方式来换取自己的生存，如果某天他们和捕食者建立交易的意愿失败，或者被合作的捕食者吞下，他们通常会极力挣扎。";
            break;
        case 'SVAX-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你通常是一个旁观者，当你看到其他人被捕食者当做食物吞进的肚子里时会感受到奇怪的兴奋，但你又害怕成为她们的食物，这也是你作为非自愿型猎物最重要的一个特征。' +
                '你可能拥有一个捕食者伙伴，并偶尔或者经常性地将其他猎物同类投喂进她的肚子里，会关注捕食者吞食猎物的社交媒体信息，会在别人被吞下时驻足观看并获得快感。' +
                '你的主动特质会潜移默化地影响你，让你与捕食者的距离越来越近，让你越来越渴望主动经历被吞食的感受，直到最后，你会越过一条曾经由你自己树立起来的警戒线。' +
                '直到这时，你的性欲望会反过来影响你，让你放下对成为食物这件事的恐惧，让你不禁思考自己距离最终无路可退的处境到底还有多少距离。' +
                'SVAX非自愿型猎物拥有一个潜移默化转换的过程，他们会从最初的害怕成为食物转化为最终的渴望经历被吞食的体验，最终将自己送入捕食者的嘴中。从这方面来看，他们更像是潜在的自愿型猎物的替补。';
            break;
        case 'SVPN-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你是真的不想被吃掉的，但如果真的被捕食者接近，你也会很快屈服并被她们肆意掌控，为所欲为。" +
                "然而，与IVPN那种认命的心态不同，你至少会确保让吃掉你的捕食者尽可能的获得享受。" +
                "如果你必须要成为一顿食物，那也必至少应该是一顿难以忘怀的大餐，能够带给捕食者极致的体验，而不是当个普通的食物，被捕食者普通的果腹然后很快遗忘。" +
                "尽管你大概不会承认，但你确实很期待在捕食者的肚子里收到她们对你味道的赞美，夸奖你为她们所做出的贡献有多么的杰出，期待你加入她们身体后她们能获得怎样的提升。" +
                "SVPN非自愿型猎物不太愿意被吃掉，但是会很快屈服并希望成为一顿让捕食者难忘的美味大餐，他们的感官特质注定了他们会对捕食者挑逗的言语产生反应。";
            break;
        case 'SVPX-U':
            ...
            textarea2.innerText =
                ...
                "SVPN-U希望自己成为一顿令捕食者难以忘怀的美味大餐，而你更专注于在束缚着自己的胃内获得快感。" +
                "你抵触成为食物，但最终在捕食者面前放弃，让自己完全处于捕食者的支配之中。" +
                "当你彻底被捕食者控制并支配时，你能获得奇怪的兴奋感，因此当你已经深陷于她们的体内，那种被彻底支配的感觉也会令你沦陷在性与欲望的沼泽中难以自拔。" +
                "SVPX非自愿型猎物不太愿意被吃掉，但是会很快屈服于被捕食者支配所带来的强烈兴奋与快感中。他们不会承认自己真实的内心情感，因此只会在被捕食者吞下去之后才开始放飞自我。";
            break;
        case 'SEAN-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "当你被捕食者吞食的时候你会发现，她们给你带来的最大的情感反馈是羞耻和屈辱。" +
                "至于胃壁给你带来的感受和体验，于你而言并不如捕食者的言语和感情上的体验重要。" +
                "你的分享特质让你更加注重对方的感受，而你的情感特质则更容易让你在乎对方的表达，两相结合之下产生了微妙的反应，这使得你极其容易被捕食者挑逗和嘲弄，从而生出屈辱情绪。" +
                "捕食者的嘲笑只会让你更加坚定地想要脱离这尴尬的局面，更加卖力的逃跑和脱困，从而维护你那脆弱的自尊心，使其不会遭受到来自吃掉你的家伙言语上的伤害。" +
                "SEAN非主动型猎物很容易遭受捉弄和羞辱，对于捕食者的言辞更加敏感，嘲笑不会让他们兴奋或者放弃，只会令他们的自尊心受到伤害，而为了避免这种心灵层面的伤害，他们会选择更加卖力的脱困。";
            break;
        case 'SEAX-U':
            ...
            textarea2.innerText =
                "有个词语用来形容你是再合适不过了：“嘴硬”！" +
                "你的分享特质让你更加注重对方的感受，而你的情感特质则更容易让你在乎对方的表达，两相结合之下产生了微妙的反应，这使得你极其容易被捕食者挑逗和嘲弄，从而生出羞耻情绪。" +
                "因此你很容易受到来自捕食者的嘲弄和挑逗，尤其是那些跟你关系亲密的捕食者。" +
                "你会在捕食者对你的戏弄中找到一些性刺激，但嘴硬的你打死也不会承认你从被她们吃掉这件事上面获得了快感。所以，你的挣扎和扭动不是因为你感受到了羞耻，而是你用来掩盖自己被捕食者支配时产生的快感。" +
                "SEAX非自愿型猎物被捕食者支配时的反应很容易诱惑和刺激到捕食者，进而给他们带来更多的戏弄和挑逗，而他们也同样能在这些挑逗中获得快感。只不过，死鸭子嘴硬的他们通常试图通过否认和挣扎来掩盖自己内心真实的欲望。";
            break;
        case 'SEPN-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "总的来说，你是极不情愿成为某位捕食者的食物的。但如果是被你信任的捕食者的软磨硬泡、威逼利诱下，你还是会愿意短暂性地扮演她们的食物。" +
                ...
                "然而，尽管你渴望掌控局面，约束捕食者的意图，但如果吃下你的捕食者开始表现得更加强势，你往往会迅速陷入被动，进而在合适的时间和捕食者的主导下变成自愿型的，她们真正的食物。" +
                "SEPN非自愿型猎物在主观层面是不情愿的，但很容易被他们的伴侣或者受信任的朋友捕食者诱拐进肚子里。只要捕食者足够强势，足够善于操纵情绪，他们就会很容易沦陷，从扮演食物转变为真正的食物。";
            break;
        case 'SEPX-U':
            ...
            textarea2.innerText =
                ...
                "你并不像你的捕食者那样享受吞食带来的快感，但你和你的捕食者亲密的关系使你通常可以克服这一点，以满足她们吃掉你的愿望。" +
                ...
                "SEPX非自愿型猎物并不特别享受被吃掉的感觉，也不太愿意成为伴侣的“玩物”，但他们仍然会为了实现伴侣的愿望和考虑到和伴侣紧密的关系，以被动的态度同意被她们吃掉。";
            break;
    }
    ...
    if (I >= S) {
        isDesc = "<b>自我 - Individual (I)</b><br>自私自利，自我中心是自我特质的核心表现，这使得拥有利己特质的个体通常只考虑自己，而不会在意对方的感受。<br>";
        switch (testType) {
            case "PRED":
                isDesc += +
                        "拥有自我特质的捕食者的行为主要以满足自身的欲望和需求为目的，不会耗费精力去刻意地满足猎物的期望。<br>" +
                    "她们不一定会反对放慢进食的节奏，或者在前戏中添加一些娱乐项目，但最终她们的目的是取悦自己。<br>";
                break;
            case "WPREY":
                isDesc +=
                    "拥有自我特质的自愿型猎物在被捕食的过程中，只关注于满足自己的欲望和需求，不太会考虑捕食者的欲望和感受。<br>" +
                    "他们的行为主要以满足自己的需求和欲望为目标，而不会过多在意捕食者是否愿意接受他们这样的食物。<br>";
                break;
            case "UPREY":
                isDesc +=
                    "拥有自我特质的非自愿型猎物在被捕食的过程中，只关注于满足自己的欲望和需求，不太会考虑捕食者的欲望和感受。<br>" +
                    "他们不太关心捕食者的体验和需求，只会自顾自地逃跑，毕竟非自愿型猎物主观上并不愿意被吞掉。<br>";
                break;
        }
    } else {
        isDesc = "<b>共享 - Shared (S)</b><br>忧他人之忧，乐他人之乐，共享特质使得拥有它的个体希望在满足自己之前先满足对方，最后与对方共同体验到彼此的快乐。<br>";
        switch (testType) {
            case "PRED":
                isDesc +=
                    "拥有共享特质的捕食者仍然会寻求实现自己的目标，但她们会首先尊重猎物的愿望，只有自己的猎物伴侣在自己这里获得了快乐，她们才会真正得到满足。<br>" +
                    "她们更喜欢吃掉那些自愿的猎物，或者诱惑猎物主动将他们奉献给自己，总之，腹中的猎物一定是自愿的，因为她们从不强硬地忽略对方的情绪和感受。<br>" +
                    "如果她们在迫不得已的情况下吃掉了强烈反抗的非自愿猎物，她们会感到懊悔，因为她们真正重视猎物的情感。<br>";
                break;
            case "WPREY":
                isDesc +=
                    "拥有共享特质的自愿型猎物会主动在被吞食的过程中取悦自己的捕食者，创造能够令她们满意的体验与经历。<br>" +
                    "他们仍然会在被吞食的过程中寻求并实现自己的目标，但他们会首先尊重捕食者的愿望，只有自己的捕食者伴侣在自己这里获得了快乐，他们才会真正得到满足。<br>" +
                    "因此，他们在许多时候都扮演着牺牲者、奉献者、服务者一类的角色，将自己的身心都献给需要他们的捕食者。<br>";
                break;
            case "UPREY":
                isDesc +=
                    "拥有共享特质的非自愿型猎物通常会以一种相对不情愿的态度来应对他们的捕食者，这种不情愿通常表现为一种迟疑，他们不太愿意，但也不太反对。<br>" +
                    "他们可能并不希望成为食物，但当他们真的被吃下去之后，他们也会很快选择顺从。<br>" +
                    "并且，通常来说他们也都可以在这个过程中得到一部分令自己自己满意的东西。<br>";
                break;
        }
    }
    if (V >= E) {
        veDesc = '<b>本能 - Visceral (V)</b><br>拥有本能特质的个体做出任何行为的底层原因都趋于本能与合理性，本能特质带来的影响往往表现在生理的层面上。<br>';
        switch (testType) {
            case "PRED":
                veDesc +=
                    "拥有本能特质的捕食者的捕食行为受到原始的饥饿感或者身体本能的欲望驱使。<br>" +
                    "她们吞食猎物的原因可能是出于生理的需要，或者是对吞食行为的渴望，甚至仅仅是为了给获取生命活动必须的能量罢了。<br>";
                break;
            case "WPREY":
                veDesc +=
            ...
            case "UPREY":
                veDesc +=
                    "拥有本能特质的非自愿型猎物通常是出于活下去的本能而趋于逃避，或者是因为被困在捕食者体内所造成的不适和痛苦驱使他们奋力反抗。<br>";
                break;
        }
    } else {
        veDesc = '<b>情感 - Emotional (E)</b><br>情感特质带来的影响趋于表现在心理的层面，这使得拥有它的个体更多地关注整个吞食过程背后的深层含义。<br>';
        switch (testType) {
            case "PRED":
                veDesc +=
                    "拥有情感特质的捕食者享受与猎物之间的关系，可能是一种情感的表达，也可能是一种支配的表现；<br>" +
                    "或者是因为她们享受把另一个生物保留在自己的体内甚至将他们转化为身体的一部分所带来的心态上的变化。她们同时也享受食物在体内祈求或挣扎所带来的情感上的冲击。<br>";
                break;
            case "WPREY":
                veDesc +=
                    "拥有情感特质的自愿型猎物享受着与捕食者之间的关系，可能是一种情感的表达，也可能是一种被支配的表现；<br>" +
                    "或者是因为他们享受被另一个生物吞下后从个体到食物的身份上的变化，甚至是期待着被捕食者消化后成为她们身体的一部分所带来的心态上的变化。<br>" +
                    "他们同时也享受被捕食者挑逗、玩弄时带来的情感上的冲击。<br>";
                break;
            case "UPREY":
                veDesc +=
                    "拥有情感特质的非自愿型猎物更希望自己能够顺利逃脱，因为他们对被捕食者以这种方式征服所带来的影响尤为看重。<br>" +
                    "不是因为他们生理上对被吞食这件事感到恐惧，而是因为被吞食后，他们再也无法继续自己的生活，甚至会因此失去生命。<br>";
                break;
        }
    }
    if (A >= P) {
        apDesc = "<b>主动 - Active (A)</b><br>主动特质驱使着个体不留余力地或者下意识地去推动事情的发展，通过付出看得见的努力去达成自己的目的。<br>";
        switch (testType) {
            case "PRED":
                apDesc +=
                    "拥有主动特质的捕食者的行动机制很简单，她们通常主动狩猎自己的猎物，主动制造能够吞下猎物的机会。<br>" +
                    "一旦她们抓住了猎物，她们可能会立刻张开嘴将猎物吞下，并且也不介意使用一些强制的手段使得猎物的抵抗无效。<br>";
                break;
            case "WPREY":
                apDesc +=
                    "拥有主动特质的自愿型猎物的行动机制很简单，他们通常主动靠近捕食者，将自己暴露在危险中，或者以摆烂的姿态面对成为食物的命运。<br>" +
                    "他们会主动渴求成为捕食者的食物，甚至主动钻进她们的肚子里，这样的主动性有时甚至会让一些资深捕食者感到迷茫……到底谁才是猎物？<br>";
                break;
            case "UPREY":
                apDesc +=
                    "拥有主动特质的非自愿型猎物的行动机制很简短，他们通常主动远离危险，想方设法使自己安全，即使被捕食者盯上，他们也会奋力反抗。<br>" +
                    "他们绝不妥协自己的命运，在捕食者的股掌之间拉扯，不放过任何逃跑的机会，即使最终被吞入腹中，他们也会竭尽全力地抵抗胃壁的挤压。<br>";
                break;
        }
    } else {
        apDesc = "<b>被动 - Passive (P)</b><br>被动特质使得个体的处境通常被事态的发展或命运所裹挟，而不是被他们主动地创造和推动。<br>";
        switch (testType) {
            case "PRED":
                apDesc +=
                    "拥有被动特质的捕食者倾向于等待猎物主动请求成为她们的食物，而不是主动出击，狩猎自己的目标。如果出现了令她们食欲大动的猎物，她们大概率仍然保持被动等待。<br>" +
                    "或者通过观察、了解自己的猎物，制定一个完美的计划令自己的猎物主动奉献自己。比如，利用自己妙曼的身材和精致的容颜诱惑他们。<br>" +
                    "拥有被动特质的捕食者通常不会承认自己是个捕食者，即使猎物出现在周围也会按捺住自己的欲望……当然，这种状态通常都持续不了太久，诱惑过大她们就会很快屈服。<br>";
                break;
            case "WPREY":
                apDesc +=
                    "拥有被动特质的自愿型猎物倾向于等待捕食者找上门来，主动吞下他们的身体，即使被捕食者盯上也不会承认自己猎物的身份和命运。<br>" +
                    "但是，一旦他们被抓住，他们通常就会出各种心理因素导致于更易屈服自己的命运。比如服从的性格、绝望无助的心理状态或者被吞食带给他们的性刺激。<br>" +
                    "自愿被吞的猎物会更积极地服从捕食者，迅速成为捕食者支配的对象进而迅速改变对自己的认知，承认自己作为食物的命运，甚至是“玩具“的身份。<br>";
                break;
            case "UPREY":
                apDesc +=
                    "拥有被动特质的非自愿型猎物会表现出怯懦的性格趋势，他们抗拒成为食物，抵触捕食者，但他们却不会积极争取自己的命运，而是表现得随遇而安，躺平摆烂。<br>" +
                    "并且，一旦他们被抓住，他们通常就会由于绝望和无助的情绪而迅速放弃抵抗。对于他们来说，在绝对的力量面前，抵抗和挣扎是没有意义的。<br>";
                break;
        }
    }
    if (X >= N) {
        xsDesc = "<b>欲望 - SeXual (X)</b><br>拥有欲望特质的个体会在吞食这件事上受到源于身体欲望的影响。<br>";
        switch (testType) {
            case "PRED":
                xsDesc +=
                    "拥有欲望特质的捕食者认为吞食猎物是一种诱惑，充满了欲望。她们通常难以抗拒吞下猎物的行为给她们的身体带来的冲击和兴奋。<br>" +
                    "与其说吞食猎物是某种爱好，她们更倾向于将吞食猎物理解为某种身体欲望的延伸，并加以享受。<br>";
                break;
            case "WPREY":
                xsDesc +=
                    "拥有性欲特质的自愿型猎物认为被吞食是一种诱惑，充满了欲望。他们通常难以抗拒被捕食者吞下的行为给他们的身体带来的冲击和兴奋。<br>" +
                    "与其说被她们吞食是某种爱好，他们更倾向于将被吞食理解为某种身体欲望的延伸，并加以享受。<br>";
                break;
            case "UPREY":
                xsDesc +=
                    "拥有性欲特质的非自愿型猎物认为被吞食是一种诱惑，充满了欲望。哪怕他们是非自愿型的猎物，他们通常也难以抗拒被捕食者吞下的行为给他们的身体带来的冲击和兴奋。<br>" +
                    "即使他们并不渴望被吞食，然而一旦他们被纳入某位捕食者的体内，他们仍然可以很快感觉到这份欲望并加以享受。<br>";
                break;
        }
    } else {
        xsDesc = "<b>感官 - SeNsual (N)</b><br>感官特质给拥有者带来的是纯粹的精神上的快乐、想法上的满足或者单纯的饥饿行为。";
        switch (testType) {
            case "PRED":
                xsDesc +=
                    "拥有感官特质的捕食者吞食猎物的行为可以具有各种各样的动机,这取决于她们的其他特质带来的影响。<br>" +
                    "一般来说，她们吞食是为了食物、满足感、增进关系或娱乐，而不是出于欲望本身。<br>" +
                    "不过这并不意味着感官特质的捕食者不能偶尔体验一下吞食给她们的身体带来的冲击和兴奋。<br>";
                break;
            case "WPREY":
                xsDesc +=
            ...
            case "UPREY":
                xsDesc +=
                    "拥有感官特质的非自愿型猎物，或许应该称你为局外人？没事儿瞎做什么题，幻想一下自己哪天遇到根本不存在的捕食者时的反应吗？<br>" +
                    "感官特质的非自愿型猎物难以从被吞食这件事里感受到到来自身体的欲望，他们更在乎被吞下这件事会给自己带来怎样的精神和心理方面的影响。<br>" +
                    "由于他们的非自愿特质，他们自始至终都是一个无辜的受害者，无法从被吞食这件事里获得任何有价值的体验，无论是精神上的还是身体上的。<br>";
                break;
        }
    }
