...
function descriptions() {
    ...
    switch (type) {
        ...
        case 'IVAX':
            ...
            textarea4.innerText =
                "IVAX型的捕食者会沉浸在猎物的蠕动和反抗中，尤其是他们在正确方向上做出的恰到好处的蠕动和刺激。\n";
            break;
        case 'IVPN':
        ...
        case 'IEAN':
            ...
            textarea2.innerText =
                ...
                "总之，你的猎物一定能给你带来一些补饥饿之外的满足。\n" +
                "吞食行为是你达成某种目的的一种手段，而不是单纯的为了进食。\n" +
                "因此，欣赏他们在你体内绝望的抵抗可以让你获得情感和精神层面的额外满足。\n";
            textarea4.innerText =
                "IEAN型捕食者不认为吞食行为是必须的事情，但她们会为了达到某种目的而选择将对方当做食物吃掉。\n";
            break;
        case 'IEAX':
        ...
        case 'IEPN':
            ...
            textarea4.innerText =
                "IEPN型捕食者充满诱惑又极度危险，她们享受诱惑猎物，吞食他们，支配他们所带来的满足感与成就感。 \n";
            break;
        case 'IEPX':
            ...
            textarea4.innerText =
                'IEPX型捕食者喜欢与猎物玩一场精心策划的情欲游戏，并在过程中享受送上门的食物。她们诱人的本性通常令人难以抗拒。\n';
            break;
        case 'SVAN':
            ...
            textarea4.innerText =
                'SVAN型捕食者往往会优先考虑猎物的体验和想法，这意味着她们的食物通常都能保持愉悦地溶解在她们的肚子里。\n';
            break;
        case 'SVAX':
            ...
            textarea4.innerText =
                'SVAX型捕食者中的小部分会给自己的感染力中滴入谎言，但大多数还是希望以真诚打动食物，照顾腹中食物的情绪。\n';
            break;
        case 'SVPN':
            ...
            textarea4.innerText =
                'SVPN型捕食者难以在自己的欲望和照顾周围人感受的纠结中做出选择，几乎不存在例外，她们最终都会屈服于自己的欲望。\n';
            break;
        case 'SVPX':
            ...
            textarea2.innerText =
                ...
                '吞下他们是你满足性欲的重要方式。\n';
            textarea4.innerText =
                'SVPX型捕食者用吞食行为取代性行为，并让自己的伴侣很好地融入其中，至于他会以怎样的形态从哪里出来……';
            break;
        case 'SEAN':
            ...
            textarea4.innerText =
                'SEAN型捕食者更关心与猎物的互动和情感联系，而不仅仅是食物摄取，猎物的概念也趋于爱人挚友，而不是食物。\n';
            break;
        case 'SEAX':
            ...
            textarea4.innerText =
                "SEAX型捕食者注重猎物的情绪和感受，将他们吸收掉能获得的欲望上的满足，她们的猎物通常都是在兴奋中融入她们的身体。\n";
            break;
        case 'SEPN':
            ...
            textarea4.innerText =
                "SEPN型捕食者几乎不会为了满足口腹之欲而吞食，也没有饥饿感之类的欲望，甚至部分个体都不认为自己是所谓的捕食者。\n";
            break;
        case 'SEPX':
            ...
            textarea4.innerText =
                "SEPX型捕食者会珍惜与她们的亲密对象建立起的情感连接，不希望他们受到任何伤害，即使是他们主动提出的伤害。\n";
            break;
        ...
        case 'IVAN-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "所有的捕食者都应该由衷地感你谢这份来自大自然的馈赠，因为你渴望被某个捕食者吃掉。\n" +
                "你幻想被她们的红唇纳入其中，渴望被她们喉咙紧紧束缚，期待被她们胃中的低吟缠绕。\n" +
                "虽然这一切还没有发生，但是你知道，无论过程如何，你注定会成为某位女孩的食物。\n" +
                "你到处寻找捕食者，并试图主动被她们吃下，以至于大部分人都知道你的存在：\n" +
                "一个随时可以拿来填饱自己的小点心。";
            textarea4.innerText =
                "IVAN-W型猎物注重于被吃掉的过程和体验，只要能被吃掉，捕食者的身份和类型并不是什么重要的事情。\n";
            break;
        case 'IVAX-W':
        ...
        case 'IVPN-W':
            ...
            textarea2.innerText =
                "关于等待这件事，你比大多数人都要熟练。\n" +
                "你很羡慕那些遭遇了捕食者的人，但是你仍然无法鼓起勇气主动出击。\n" +
                "你的被动特质阻止了你进一步接近捕食者，即使你十分渴望被她们的胃壁包裹。\n" +
                "因此你会一直等下去，就像深山里的一颗红透的灌木浆果，等待着巧合之下闯入密林的她。\n" +
                "因为你相信，总会有一名捕食者悄悄盯上你，然后在她饥渴的欲望中将你吞入腹中。\n";
            textarea4.innerText =
                "IVPN-W型猎物等待着被捕食者吞下的机会，被吞食于他们而言是一种精神上的满足。\n";
            break;
        case 'IVPX-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你几乎时刻都深陷在被捕食者吞下的幻想中，这些幻想令你无法自拔，难以抗拒。\n" +
        ...
        case 'IEAN-W':
            ...
            textarea2.innerText =
                ...
                "你会将这份期待化为动力主动去寻找捕食者，想要在她们的体内找到那一份属于自己的安宁。\n";
            textarea4.innerText =
        ...
        case 'IEAX-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你的兴趣与爱好繁多且杂乱，对捕食者的倾向也是如此，并且你显然不打算浅尝辄止。\n' +
                '就像是新鲜出炉的芒果冻干，被运往世界各地的商店，期待着被不同的少女品尝。\n' +
                '因此，你享受被吞食给你带来的快乐，在肠胃的刺激中寻求性快感；\n' +
                '你也会四处探险，寻找新的喉咙与肚子进行探索，而不是被约束在某一个具体的捕食者的一个肚子里。\n' +
                '至少，你主观上是这样期待的。\n';
            textarea4.innerText =
                'IEAX自愿型猎物过于主动，过于自我，他们会忽略捕食者希望他们留下的意愿，如同花心男友狠心抛弃清纯少女。\n' +
        ...
        case 'IEPN-W':
            ...
            textarea2.innerText =
                ...
                "所以你期待着总有一天，你的某些特质会恰好让某个随机捕食者产生食欲，随后她一口吞掉了你。";
            textarea4.innerText =
        ...
        case 'IEPX-W':
            ...
            textarea2.innerText =
                ...
                '你的被动特性通常让你在捕食者面前显得无比乖巧与顺从；\n' +
                '那些善于戏弄自己猎物或者善于调情的捕食者能够更好地激发你的性欲，而你只能任凭她们摆布。\n' +
                '就像是一颗晶莹剔透的诱人软糖，被她含在嘴里，牙齿轻咬，柔舌舔舐，一点一点地融化在她的体内~\n' +
                '被吞掉于你而言几乎与被啪了无异，所以你更喜欢那些性感迷人的捕食者，尤其是那些能够撩动你内心的人。';
            textarea4.innerText =
                'IEPX-W型猎物更容易受到捕食者的影响，或者说，她们的存在本身就会不断刺激他们的情绪感官，哪怕只是想想都兴奋不已。';
            break;
        case 'SVAN-W':
            ...
            textarea2.innerText =
                ...
                "比起成为随机陌生的捕食者的食物，你更倾向于为自己的朋友或者真正需要自己的人保留自己的价值。\n" +
            ...
            textarea4.innerText =
                "SVAN-W型猎物能够很快结交到捕食者朋友，当他们双方都产生了吞食相关的欲望时，可以拜托或者直接消耗对方。";
            break;
        case 'SVAX-W':
            ...
            textarea2.innerText =
                ...
                '你会难以遏制地通过打扮、穿着、气味等的方式主动吸引那些潜在的捕食者，让她们为你分泌唾液。\n' +
                '当你了解到某位捕食者的捕食规律时，你也会选择触发它们，激起她们的食欲，将你吞下。\n' +
                '就像是撒了特制香料的风味烤串，你存在的目的就是为了吸引她更快，更早，更渴望地品尝你的味道。\n' +
                '同时你也会积极地主张和她们一起涩涩，体验被她们吃掉的刺激，在她们的腹中宣泄自己的欲望。';
            textarea4.innerText =
                'SVAX-W型猎物喜欢寻求性刺激，并同时与捕食者维系着食者与食物的紧密关系，这些对他们而言并非是选择题，而是相辅相成的极致体验。';
            break;
        case 'SVPN-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "虽然你并不积极寻求成为食物的机会，但你仍然可能会结识多位潜在的捕食者朋友。\n" +
                "你的目的很明确，你期望着她们中的某一位最终会做出吃掉你的决定并赴之于行动。\n" +
                "比起这个，你反而很难说服自己和陌生的捕食者进行尝试。\n" +
        ...
        case 'SVPX-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你努力与吸引着你的那些捕食者个体建立联系，希望能够有幸进入她们性感的体内。\n' +
            ...
            textarea4.innerText =
                'SVPX-W型猎物善于在被吃掉的过程中取悦捕食者，并且他们自己也能在这个过程中获得满足，直到彻底放飞自我。';
            break;
        case 'SEAN-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你在快乐的解读上有着和捕食者共通的观点，即她不希望你离开她的肚子，你也不想离开。\n' +
                '你会积极促进双方更快地进入到吞食的阶段，在她们的肚子里给到她们最舒适的按摩。\n' +
                '你可能还会希望能与捕食者融为一体，因为你认为你们双方都将从“食物成为更强大个体的一部分”中受益。\n' +
                '你就像是被她囫囵吞下的脆皮烤肠，香甜可口之余，你保证了自己归宿的主观性，她获得了你提供的能量和曲线。\n' +
                '于你而言和她们的情感连接更重要，而不是被吃掉本身，所以你也会觉得那些单纯把你视为食物的人会有些偏激。\n';
            textarea4.innerText =
                'SEAN-W型猎物渴望与捕食者拥有更加亲密的关系，享受被吞食所带来的特殊的含义，待在她们体内就能获得快乐和满足。';
            break;
        case 'SEAX-W':
            ...
            textarea2.innerText =
                ...
                "你擅长勾引或利用性挑逗和嘲弄刺激捕食者，使她们迅速进入充满欲望的的状态然后吞下你。\n" +
                "你认为只有双方都处于开心和期待情绪下，吞食才存在积极意义，所以你不希望被那些过于自我的捕食者吞下。\n" +
                "如果捕食者足够吸引你，你也会渴望如同一勺黑糖布丁被她送进嘴里，吞入腹中，被她消化吸收，成为她的一部分。\n" +
        ...
        case 'SEPN-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你乐于无私奉献自己以成为捕食者的食物并享受这个过程给你带来的快乐。\n" +
                "你渴望与捕食者建立更加亲密的联系，因此能支配你的都是你认可的朋友捕食者而不是陌生人。\n" +
                "你是一个专注于满足朋友的角色，通常会选择将控制权彻底交给她们。\n" +
                "就像是一颗被她含在嘴里的阿尔卑斯，任凭她想要支配你多久，你都能够感受到无比的满足。\n" +
                "因此你更像是朋友的私人小零食或者解压玩具，每当她们需要的时候你都会被她们肆意地拿走和使用。\n";
            textarea4.innerText =
                "SEPN-W型猎物被吃掉的感觉要高于性兴奋。他们是绝对服从的奴隶，将自己的一切献给被他们认可的捕食者朋友。";
            break;
        case 'SEPX-W':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你专注于满足捕食者，在她们需要的时候用“可食用性玩具”的身份取悦她们。\n' +
                '你愿意将自己彻底交给她们以此来满足自己的性欲，甚至包括被她们消化。\n' +
                '你就像是为她而生的水果青瓜，用途多样且清脆爽口，无论她打算怎样使用，彼此都能得到想要的满足。\n' +
                '你渴望与捕食者建立更加亲密的联系，因此能够品尝到你的基本是你的朋友，爱人或主人，而不是陌生人。\n' +
                '同时，你的情感特质也令你渴望被捕食者调情和赞美，并与她们建立更加长久的联系。\n';
            textarea4.innerText =
                'SEPX-W型猎物会在被支配时感到性愉悦，他们渴望情感上的互动，因此他们能够选择的捕食者数量不多，但关系却更为亲密。';
            break;
        ...
        case 'IVAN-U':
            ...
            textarea4.innerText =
                "IVAN-U型猎物不会屈服于自己的命运和身份，当他们被卷入捕食者的嘴里，唯一的想法就是逃离这里并活下去。";
            break;
        case 'IVAX-U':
        ...
        case 'IVPN-U':
            ...
            textarea2.innerText =
                ...
                '你知道作为猎物，大概率是要被捕食者吃掉的，因此在命运真的降临时只会进行基本的抵抗。\n' +
                '你难以在胃壁中抵抗太久，尽管这会使某些期待食物挣扎的捕食者感到无聊，进而考虑放你一马……？\n' +
                '那么，你认为活下来的结局真的是你所期待的吗？还是说……\n';
            textarea4.innerText =
                'IVPN-U型猎物很容易放弃他们的抵抗，并在捕食者的腹中轻易接受他们的命运，他们的被动特质使得他们无法坚持退太久。';
            break;
        case 'IVPX-U':
            ...
            textarea2.innerText =
                ...
                "你绝对是一个复杂的猎物，因为你知道被吞食这件事到底有多么的危险，捕食者的体内到底有多么恶心。\n" +
                "但如果你真的深陷其中，你就会很快屈服。一旦捕食者开始吞食你，你就会感到兴奋。\n" +
        ...
        case 'IEAN-U':
            ...
            textarea2.innerText =
                ...
                "因为你在被捕食者抓住之后就和开始后悔原来自己还有很多理想可以实现。\n" +
                "所以，你开始挣扎，开始反抗自己的命运，开始向往自由，开始劝说她们放过你。\n" +
                "你的情感特质是你优秀的武器，能够更加容易地对那些顾及猎物感受、拥有共情能力的捕食者造成影响。\n" +
                "她们或许真的会考虑放过你……但，这样的捕食者又能有多少呢？\n";
            textarea4.innerText =
                "IEAN-U型猎物可以通过自己的EA特质来劝说捕食者放过自己，但这份力量通常只对SE特质的捕食者有效。";
            break;
        case 'IEAX-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "虽然你会尽量避免被吃掉的处境，但捕食者在你面前张开嘴时，你还是会忍不住多看一眼……\n" +
                "你会在捕食者的面前以及里面坚定地抵抗，声称自己不是食物，而这一切不过是为了掩盖你的兴奋和激动。\n" +
                "因为你知道这样通常都能勾起捕食者玩弄自己猎物的兴趣，进而将这种兴趣在你的身上付之行动……\n" +
                "是的，你的抵抗，挣扎和反对，其实本质上就是在说，“快，快欺负我！我真的很享受！”\n" +
                "只要她们开始嘲笑你的反抗，享受你的挣扎，描述你将来会加入的部位，你就能在她们的肚子里蠕动一整个夜晚。\n";
            textarea4.innerText =
                "IEAX-U型猎物通过坚决的挣扎和抗议来掩盖自己的兴奋，沉浸于被捕食者嘲弄的情感享受。";
            break;
        case 'IEPN-U':
        ...
        case 'SVAN-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "其他的猎物偶尔能看到你和一位捕食者同时出现，但你从未消失在他们活动的区域。\n" +
                "要问为什么的话，或许曾经被你投喂给她的张三李四王五可以回答这个问题……\n" +
                "你通过和她们建立连接或交易，成为她们的长期饭票，让她们相信你能带来更多食物的同时受她们保护。\n" +
                "你更像是她们的饲养员，你总是为她们提供新的猎物，以保证自己不会是她们的下一顿。\n" +
                "但你应该随时警惕她们肚子里的咕噜声，毕竟……很多捕食者并不擅长等待和忍耐。\n";
            textarea4.innerText =
                "SVAN-U型猎物与捕食者进行交易，用牺牲其他同类的方式换取自己的生存，如果这份交易突然失效，他们也会极力抵抗。";
            break;
        case 'SVAX-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                '你通常以旁观的视角欣赏和期待其他人被捕食者吞进的肚子，并从中获得兴奋和激动，但你又害怕成为她们食物。\n' +
                '享受吞食带来的性刺激，又不敢亲身经历，这正是你作为非自愿型的典型表现。\n' +
            ...
            textarea4.innerText =
                'SVAX-U型猎物会从最初的害怕潜移默化地转化为最终的渴望经历被吞食的体验，最终将自己送入捕食者的嘴中。\n' +
        ...
        case 'SVPN-U':
            ...
            textarea4.innerText =
                "SVPN-U型猎物会很快屈服并希望成为一顿难忘的美味大餐，他们的感官特质注定了他们会对捕食者挑逗的言语产生反应。";
            break;
        case 'SVPX-U':
            ...
            textarea2.innerText =
                ...
                "当你彻底被捕食者控制并支配时，你能获得额外的兴奋感；\n" +
                "因此当你已经深陷于她们的体内，那种被彻底支配的感觉也会令你沦陷在性与欲望的沼泽中难以自拔。\n";
            textarea4.innerText =
                "SVPX-U型猎物会很快屈服并沉浸于被捕食者支配所带来的强烈兴奋与快感中，并且通常只会在被吞下去之后开始放飞自我。";
            break;
        case 'SEAN-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "当你被捕食者吞食的时候你会发现，她们给你带来的最大的情感反馈竟然羞耻和屈辱。\n" +
        ...
        case 'SEAX-U':
            ...
            textarea2.innerText =
                ...
                "然而你的挣扎和蠕动动不是因为你感受到了羞耻，而是你用来掩盖自己被捕食者支配时产生的快感。";
            textarea4.innerText =
        ...
        case 'SEPN-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "总的来说，你是极不情愿成为某位捕食者的食物的。\n" +
                "但在被你信任的捕食者朋友的软磨硬泡、威逼利诱下，你还是会愿意短暂性地扮演她们的食物。\n" +
        ...
        case 'SEPX-U':
            ...
            textarea.innerHTML = typeDesc;
            textarea2.innerText =
                "你并不像你的捕食者那样享受吞食带来的一切，比如满足感什么的。\n" +
                "但你和你的捕食者亲密的关系使你通常可以克服这一点，以满足她们吃掉你的愿望。\n" +
    ...
    let speciality = {
        I: {
            ...
            PRED: "拥有自我特质的捕食者的行为主要以满足自身的欲望和需求为目的，不会耗费精力去刻意地满足猎物的期望。<br>" +
                "她们中的某些个体会放慢进食的节奏或者添加一些娱乐项目，但这一切的最终目的都是为了取悦她们自己。",
            WPREY: "拥有自我特质的自愿型猎物在被捕食的过程中，只关注于满足自己的欲望和需求，不太会考虑捕食者的欲望和感受。<br>" +
                "他们的行为主要以满足自己的需求和欲望为目标，而不会过多在意捕食者是否愿意接受他们这样的食物。",
            UPREY: "拥有自我特质的非自愿型猎物在被捕食的过程中，只关注于满足自己的欲望和需求，不太会考虑捕食者的欲望和感受。<br>" +
                "他们不太关心捕食者的体验和需求，只会自顾自地逃跑，毕竟非自愿型猎物主观上并不愿意被吞掉。"
        },
        S: {
            TITLE: "<b>共享 - Shared (S)</b>",
            HEAD: "共享特质令拥有它的个体懂得忧他人之忧，乐他人之乐，而不是一味地满足自己。",
            PRED: "拥有共享特质的捕食者会在吞食的过程中主动取悦自己的猎物。<br>" +
                ...
                "如果她们在迫不得已的情况下吃掉了强烈反抗的非自愿猎物，那么她们多少都会难过一段时间。<br>",
            WPREY: "拥有共享特质的自愿型猎物会在被吞食的过程中主取悦自己的捕食者。<br>" +
                "他们仍然会想办法让自己得到满足，但他们会首先尊重捕食者的愿望。<br>" +
                "只有自己的捕食者伴侣在自己这里获得了快乐，他们才会真正得到满足。<br>" +
                "因此，他们在许多时候都扮演着牺牲者、奉献者一类的角色，将自己的身心都献给吞下他们的人。<br>",
            UPREY: "拥有共享特质的非自愿型猎物通常会以一种相对不情愿的态度来应对他们的捕食者。<br>" +
                "这通常表现为一种迟疑：他们不太愿意，但也不太反对。<br>" +
                "他们可能会不太愿意给捕食者造成伤害，进而将对死亡的恐惧转化为对奉献的认可。<br>" +
                "因此他们可能并不希望成为食物，但当他们真的被吃下去之后，他们也会很快选择顺从。<br>"
        },
        V: {
            TITLE: "<b>本能 - Visceral (V)</b>",
            HEAD: "本能特质影响个体的行为趋于本能与合理性，这种影响往往表现在生理的层面上。",
            PRED: "拥有本能特质的捕食者的捕食行为受到原始的饥饿感或者来自身体本能的欲望驱使。<br>" +
        ...
        A: {
            ...
            PRED: "拥有主动特质的捕食者的行动机制很简单，她们通常主动狩猎自己的猎物，主动创造能够吞下猎物的机会。<br>" +
                "被她们抓住的猎物可能会被她们毫不犹豫地物吞下，直奔主题向来是主动特质的一大表现。<br>" +
                "如果遭受到猎物的反抗也无所谓，她们不会介意使用一些强制的手段让这些反抗无效化。<br>",
            WPREY: "拥有主动特质的自愿型猎物的行动机制很简单：<br>" +
                "他们通常主动靠近捕食者，将自己暴露在危险中，或者以摆烂的姿态面对成为食物的命运。<br>" +
                "他们会主动渴求成为捕食者的食物，甚至主动钻进她们的肚子里。<br>" +
                "这样的主动性有时甚至会让一些资深捕食者感到迷茫……到底谁才是猎物？<br>",
            UPREY: "拥有主动特质的非自愿型猎物的行动机制很简单：<br>" +
                "他们通常主动远离危险，想方设法使自己安全，即使被捕食者盯上，他们也会奋力反抗。<br>" +
                "他们绝不妥协自己的命运，在捕食者的股掌之间拉扯，不放过任何逃跑的机会。<br>" +
                "即使最终被吞入腹中，他们也会竭尽全力地抵抗胃壁的挤压。<br>"
        },
        P: {
            TITLE: "<b>被动 - Passive (P)</b>",
            HEAD: "被动特质影响个体的行为趋于消极，他们从不主动去创造和推动对自己有利的处境。",
            PRED: "拥有被动特质的捕食者倾向于等待猎物成为她们的食物，而不是主动出击，狩猎自己的目标。<br>" +
                "如果出现了令她们食欲大动的猎物，她们大概率仍然保持被动等待。<br>" +
                "她们也会通过观察、了解自己的猎物，制定一个完美的计划令自己的猎物主动奉献自己。<br>" +
                "她们通常不会轻易承认或者暴露自己的捕食者身份，即使猎物就在身边也能控制住疯狂分泌的唾液。<br>" +
                "当然，这种状态通常都是脆弱的，诱惑过大她们就会很快屈服。<br>",
            WPREY: "拥有被动特质的自愿型猎物不会刻意去寻找捕食者，也不会刻意躲着她们。<br>" +
            ...
            UPREY: "拥有被动特质的非自愿型猎物通常会是一个失败主义者。<br>" +
        ...
        X: {
            ...
            PRED: "拥有性欲特质的捕食者认为吞食猎物是一种诱惑，充满了情欲。<br>" +
                "她们通常难以抗拒吞下猎物的行为带来的身体上的冲击和兴奋。<br>" +
                "与其说吞食猎物是某种爱好或者娱乐，她们更倾向于将吞食猎物理解为性欲的延伸，并加以享受。<br>",
            WPREY: "拥有性欲特质的自愿型猎物认为被吞食是一种诱惑，充满了情欲。<br>" +
                "他们通常难以抗拒被捕食者吞下时带来的身体上的冲击和兴奋。<br>" +
                "与其说被她们吞食是某种爱好或者娱乐，他们更倾向于将被吞食理解为性欲的延伸，并加以享受。<br>",
            UPREY: "拥有性欲特质的非自愿型猎物认为被吞食是一种诱惑，带着情欲的成份。<br>" +
                "他们通常难以抗拒被捕食者吞下时附带的身体上的冲击和兴奋，哪怕他们抗拒被吞掉这件事本身。<br>" +
                "即便如此，一旦他们被纳入某位捕食者的体内，他们仍然可以很快感觉到这份欲望并加以享受。<br>"
        },
        N: {
            TITLE: "<b>感官 - SeNsual (N)</b>",
            HEAD: "感官特质能够摒弃欲望的影响，给个体带来纯粹的精神上的快乐和想法上的满足。",
            PRED: "拥有感官特质的捕食者吞食猎物的行为可以具有各种各样的动机，这取决于她们的其他特质带来的影响。<br>" +
                "一般来说，她们吞食是为了果腹、获得满足感、和食物增进关系或单纯的娱乐行为，而不是出于性体验。<br>" +
                "不过这并不意味着感官特质的捕食者不能偶尔体验一下吞食给她们的身体带来的性冲击和兴奋。<br>",
            WPREY: "拥有感官特质的自愿型猎物更注重于被吞食这件事带给自己的精神方面的体验而不是肉体的欲望。<br>" +
                "他们并不在乎甚至感受不到被吞食带来的身体方面的欲望，而是专注于感受自己心中的渴望被实现所带来的满足感。",
            UPREY: "拥有感官特质的非自愿型猎物，或许应该称你为局外人？<br>" +
                "意外被卷入吞食场景的他们中，有一部分似乎在潜意识里对吞食有着微妙的见解。<br>" +
                "感官特质的非自愿型猎物难以从被吞食里感受到到来自身体的欲望；<br>" +
                "而是更在乎这件事会给自己带来怎样的精神和心理方面的影响。<br>" +
                "这种情况一旦遇上非自愿特质，就会使得他们更像是一个无辜的受害者；<br>" +
